    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="#" data-bind="click: showHome">How To Train Your Robot</a>
            </div>

            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li><a href="#" data-bind="click: showAbout">About</a></li>
                    <li><a href="#" data-bind="click: showHighScores">High Scores</a></li>
                    <li><a href="#" data-bind="click: showLevelJump">Level Jump</a></li>
                </ul>
...
<script>
    ...
    require(['common'], function (common) {
        require(
            ['jquery', 'knockout', 'app/applicationViewModel', 'jstree', 'bindings/inventoryTree', 'bindings/programTree'],
            function ($, ko, ApplicationViewModel, jstree, inventoryTree, programTree) {
