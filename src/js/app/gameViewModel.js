define(
    ...
    function (ko, _, levels, allInstructionsLookup, programTree, inventoryTree, services, bootstrap, ScoreCalculator, personaDialog, StatusViewModel, EnvironmentViewModel, controllers, directives) {
        ...
        return function GameViewModel() {
            ...
            self.endStoryText = ko.observable("<p>Thank you for helping Robo repair the spaceship so that he can continue his journey.  </p><p>  We hope you learned new things while playing this game. Feel free to play again and we hope to see you soon!   </p> ");
